...
export const metadata: Metadata = {
  ...
  description:
    "Материалы, лекции и примеры по структурному синтезу программирования.",
  keywords: [
  ...
  return (
    ...
    <html lang="ru" suppressHydrationWarning>
      <head>
        ...
        <meta name="theme-color" content="#AC6AFF" />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Структурный синтез программ — Учебный портал"
        />
        <meta
          property="og:description"
          content="Материалы, лекции и примеры по структурному синтезу программирования."
        />
        <meta property="og:url" content="https://physics-plum.vercel.app" />
        <meta property="og:site_name" content="Структурный синтез программ" />
        <meta
          property="og:image"
          content="https://github.com/Saaayurii/Physics/blob/main/public/assets/Physics.png"
        />
